...
public class AdminController : Controller
{
    ...
    report.WalletRelationshipsRequiringTracing,
            // Section 8
            MatterReportedToCourt = report.MatterReportedToCourt,
            ...
            UpcomingHearingsOrDeadlines = report.UpcomingHearingsOrDeadlines,
            UpcomingHearingDetails = report.UpcomingHearingDetails,
            EvidenceSubmittedToCourt = report.EvidenceSubmittedToCourt,
            EvidenceSubmittedDetails = report.EvidenceSubmittedDetails,
            CourtRequestedIndependentInvestigation = report.CourtRequestedIndependentInvestigation,
            DisputedAssetsIdentifiedInProceedings = report.DisputedAssetsIdentifiedInProceedings,
            NonComplianceWithCourtOrder = report.NonComplianceWithCourtOrder,
